...
const ZOOP_API_URLS = {
    PAN_LITE: 'https://live.zoop.one/api/v1/in/identity/pan/lite',
    PAN_ADVANCE: 'https://live.zoop.one/api/v1/in/identity/pan/advance',
    PAN_DEMOGRAPHIC: 'https://live.zoop.one/api/v1/in/identity/pan/demographic',
    VOTER_ADVANCE: 'https://live.zoop.one/api/v1/in/identity/voter/advance',
    DRIVING_LICENCE_ADVANCE: 'https://live.zoop.one/api/v1/in/identity/dl/advance',
    PASSPORT_LITE: 'https://live.zoop.one/api/v1/in/identity/passport/lite',
    CKYC_LITE: 'https://live.zoop.one/api/v1/in/identity/ckyc/lite',
    OKYC_LITE: 'https://live.zoop.one/in/identity/okyc/otp/request',
    OKYC_OTP_LITE: 'https://live.zoop.one/in/identity/okyc/otp/verify',
    GSTIN_LITE: 'https://live.zoop.one/api/v1/in/merchant/gstin/lite',
    GSTIN_ADVANCE: 'https://live.zoop.one/api/v1/in/merchant/gstin/advance',
    BANK_VERIFICATION_LITE: 'https://live.zoop.one/api/v1/in/financial/bav/lite',
    RC_LITE: 'https://live.zoop.one/api/v1/in/vehicle/rc/lite',
    RC_ADVANCE: 'https://live.zoop.one/api/v1/in/vehicle/rc/advance',
    IFSC_LITE: 'https://live.zoop.one/api/v1/in/utility/ifsc/lite',
    OCR_LITE: 'https://live.zoop.one/api/v1/in/utility/ocr/lite',
    EPFO_PRO: 'https://live.zoop.one/api/v1/in/identity/epfo/pro',
    PAN_206AB: 'https://live.zoop.one/api/v1/in/identity/pan/206ab',
    PAN_MICRO: 'https://live.zoop.one/api/v1/in/identity/pan/micro',
    PAN_PRO: 'https://live.zoop.one/api/v1/in/identity/pan/pro',
    PASSPORT_ADVANCE: 'https://live.zoop.one/api/v1/in/identity/passport/advance',
    CIN_ADVANCE: 'https://live.zoop.one/api/v1/in/merchant/cin/advance',
    FSSAI: 'https://live.zoop.one/api/v1/in/merchant/fssai/number',
    GST_PAN: 'https://live.zoop.one/api/v1/in/merchant/gstpan/lite',
    UDYOG_AADHAAR: 'https://live.zoop.one/api/v1/in/merchant/udyog/lite',
    CORPORATE_VERIFICATION: 'https://live.zoop.one/api/v1/in/persona/corporate/verification',
    CHEQUE_OCR: 'https://live.zoop.one/api/v1/in/utility/ocr/cheque',
    EMAIL_VERIFICATION_REQUEST: 'https://live.zoop.one/api/v1/in/persona/email/verification/request',
    EMAIL_VERIFICATION_SUBMIT: 'https://live.zoop.one/api/v1/in/persona/email/verification/submit',
    AADHAAR_ESIGN: 'https://live.zoop.one/contract/esign//v5/init',
    OCR_SDK: 'https://live.zoop.one/ocr/v1/init',
    FACE_CROP: 'https://live.zoop.one/api/v1/in/ml/face/crop',
    FACE_MATCH: 'https://live.zoop.one/api/v1/in/ml/face/match'
};
