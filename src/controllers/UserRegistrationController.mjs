...
class UserRegistrationController{
    ...
    static async validateUserData(data) {
        const { userName, email, mobile, password, packageName, services, role, panNumber, gstNumber, address, status } = data;
        ...
        if (password) {
            ...
            await sendEmail(email, `Login Credintials for Verify Documentat `, `Your autogenerated password is: ${newPassword}`);
